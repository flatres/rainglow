  ...
  <q-page-container class="fit">
    ...
    <div class="q-pa-md fit rainglow-wrapper bg-white">
      ...
      <div v-else class="rainglow-ring-container">
          ...
          >
            ...
            <div class="outer-led-info">
              ...
              <div class="outer-led-meta">
                ...
                >
                  {{ seg.dayOffset === 0 ? 'Today' : 'Tomorrow' }}
                </span>
                <span class="q-ml-xs">
        ...
        <!-- SUMMARY LINE -->
        <div class="q-mt-sm text-body2 rg-summary" v-if="summaryText">
          {{ summaryText }}
        </div>
  ...
  computed: {
    ...
    segments () {
      ...
      for (let i = 0; i < 6; i++) {
        ...
        const x = polar.radius * Math.cos(rad) - 12
        const y = polar.radius * Math.sin(rad) - 10
